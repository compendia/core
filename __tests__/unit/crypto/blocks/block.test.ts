...
describe("Block", () => {
    ...
    describe("constructor", () => {
        ...
        it("should fail to verify a block with invalid S in signature (not low S value)", () => {
            // TODO (dean): Generate an appropriate block signature for this block so it's valid
    ...
    describe("serializeWithTransactions", () => {
        ...
        //     it.each([["mainnet", 468080], ["devnet", 14524], ["testnet", 46520]])(
        //         "%s",
    ...
    it("should reorder correctly transactions in deserialization", () => {
        ...
        const feeObj = FeeHelper.getFeeObject(Utils.BigNumber.make(600000000), Utils.BigNumber.make(200000000));
